...
class DiabetesModelTrainer:
    ...
    def optimize_hyperparameters(self, X_train, y_train, X_test, y_test, model_type='random_forest'):
    ...
    def train_complete_pipeline(self):
        ...
        self.generate_training_summary(baseline_results, optimized_metrics, best_baseline)
        
        return optimized_model, optimized_metrics
    
    def generate_training_summary(self, baseline_results, optimized_metrics, best_model):
