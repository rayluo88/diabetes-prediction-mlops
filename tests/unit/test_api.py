...
class TestDiabetesAPI:
    ...
    def test_predict_endpoint_success(self, mock_preprocessor, mock_model, client, sample_patient_data):
    ...
    @patch('api.diabetes_api.preprocessor')
    @patch('api.diabetes_api.model_version', "test_v1")
    def test_batch_predict_endpoint_success(self, mock_preprocessor, mock_model, 
                                           client, sample_batch_data):
    ...
    def test_model_info_endpoint(self, client):
        ...
        with patch('api.diabetes_api.model_version', "test_v1"), \
...
class TestAPIErrorHandling:
    ...
    @patch('api.diabetes_api.model')
    @patch('api.diabetes_api.preprocessor')
    def test_prediction_internal_error(self, mock_preprocessor, mock_model, 
                                     client, sample_patient_data):
    ...
    @patch('api.diabetes_api.model')
    @patch('api.diabetes_api.preprocessor')
    def test_preprocessing_error(self, mock_preprocessor, mock_model, 
                               client, sample_patient_data):
...
class TestAPIPerformance:
    ...
    @patch('api.diabetes_api.model')
    @patch('api.diabetes_api.preprocessor')
    def test_prediction_response_time(self, mock_preprocessor, mock_model, 
                                    client, sample_patient_data):
