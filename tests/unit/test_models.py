...
class TestDiabetesModelTrainer:
    ...
    def test_train_baseline_models(self, mock_makedirs, mock_joblib_dump, 
                                 mock_log_model, mock_log_metric, mock_log_params,
                                 mock_start_run, trainer, sample_training_data):
        ...
        results, best_model = trainer.train_baseline_models(X_train, X_test, y_train, y_test)
    ...
    def test_optimize_hyperparameters_random_forest(self, trainer, sample_training_data):
        """Test hyperparameter optimization for random forest."""
        X_train, X_test, y_train, y_test = sample_training_data
        
        with patch('models.train_diabetes_model.optuna.create_study') as mock_create_study, \
    ...
    def test_optimize_hyperparameters_gradient_boosting(self, trainer, sample_training_data):
    ...
    def test_register_champion_model(self, mock_client_class, mock_log_model, 
                                   mock_log_metric, mock_start_run, trainer):
    ...
    def test_generate_training_summary(self, trainer, sample_training_data):
        ...
        trainer.generate_training_summary(baseline_results, optimized_metrics, "random_forest")
